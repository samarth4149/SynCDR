...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--filelist_root', default='../SynCDR/data', help='path to filelist root')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unalignedfilelist', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | unalignedfilelist]')
